...
export default function Home() {
    return (
        <>
            ...
            <button className="bg-red-lth text-white text-sm px-3 mb-32 py-1 rounded-lg flex items-center justify-center mx-auto"> <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" className="w-7 h-7">
