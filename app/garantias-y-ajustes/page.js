...
export default function Home() {
    return (
        <>
            ...
            <button className="bg-red-lth text-white text-sm w-60 mb-8 py-2 rounded-lg flex items-center justify-center mx-auto"> Descargar garantía </button>
            <div className="bg-grey-lth text-center uppercase font-medium p-2">
                <h2 className="w-96 mx-auto"> informacion importante sobre la garantía</h2>
            </div>
            ...
            <button className="bg-red-lth text-white text-sm w-60 mb-8 py-2 rounded-lg flex items-center justify-center mx-auto">Descargar informacion</button>
            <Cards page="all" />
            <Whatsapp />
        </>
    );
