...
// // Componente de Ubicación: muestra una lista de centros de servicio con dirección y enlace a Google Maps
// export const Location = () => {
//   // Lista de direcciones de centros de servicio
//   const direcciones = [
//     {
...
//       {/* Mapea cada dirección y la muestra en una tarjeta clicable */}
...
//           className="block mb-5 p-5 lg:w-[700px] lg:mx-auto border border-gray-300 rounded-lg hover:shadow-lg transition-shadow duration-300"
//         >
//           <div className="flex items-center">
//             {/* Animación Lottie en lugar del ícono de ubicación */}
//             <div className="w-10 h-10 mr-4">
//               <DotLottieReact
//                 src="/animations/icon_location.json" // Ruta de la animación
//                 loop
//                 autoplay
...
//   );
// };
// Habilita el uso del componente en el cliente
'use client';
      ...
      {direcciones.map((direccion, index) => (
        ...
        >
          <div className="flex items-center">
            ...
            <DotLottieReact
              src="/animations/icon_location.json" // Cambiar a la ruta relativa
